...
python3 ~/Documents/code/convertMacros/convertMacros.py -i 'MEmu/no_refills_[480]_[memu].txt' -o 'Nox/no_refills_[480]_[memu].txt' --in-x 480 --in-y 854 --out-x 854 --out-y 480 --flip-y --outtype nox
python3 ~/Documents/code/convertMacros/convertMacros.py -i 'MEmu/no_refills_[480]_[memu].txt' -o 'Hiro/no_refills_[480]_[memu].txt' --in-x 480 --in-y 854 --out-x 854 --out-y 480 --flip-y --outtype hiro

python3 ~/Documents/code/convertMacros/convertMacros.py -i 'MEmu/no_refills_+_timer_[480]_[memu].txt' -o 'Nox/no_refills_+_timer_[480]_[memu].txt' --in-x 480 --in-y 854 --out-x 854 --out-y 480 --flip-y --outtype nox
python3 ~/Documents/code/convertMacros/convertMacros.py -i 'MEmu/no_refills_+_timer_[480]_[memu].txt' -o 'Hiro/no_refills_+_timer_[480]_[memu].txt' --in-x 480 --in-y 854 --out-x 854 --out-y 480 --flip-y --outtype hiro
