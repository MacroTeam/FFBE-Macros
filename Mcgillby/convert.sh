...
python3 ~/Documents/code/convertMacros/convertMacros.py -i 'MEmu/no_refills_720.txt' -o 'MEmu/y-flipped/no_refills_720-flipped.txt' --in-x 720 --in-y 1280 --flip-y --outtype hiro
python3 ~/Documents/code/convertMacros/convertMacros.py -i 'MEmu/no_refills_+_timer_720.txt' -o 'MEmu/y-flipped/no_refills_+_timer_720-flipped.txt' --in-x 720 --in-y 1280 --flip-y --outtype hiro
python3 ~/Documents/code/convertMacros/convertMacros.py -i 'MEmu/tm_refills_720.txt' -o 'MEmu/y-flipped/tm_refills_720-flipped.txt' --in-x 720 --in-y 1280 --flip-y --outtype hiro
